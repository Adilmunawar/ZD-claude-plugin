...
| `npm error 404 @adilmunawar/zd-tools is not in this registry` | The package is on GitHub Packages, not npmjs | Install from the release tarball: `npm i -g https://github.com/Adilmunawar/ZD-claude-plugin/releases/download/v7.3.5/adilmunawar-zd-tools-7.3.5.tgz` |
