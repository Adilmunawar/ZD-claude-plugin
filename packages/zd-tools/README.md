...
npm i -g github:Adilmunawar/ZD-claude-plugin#v7.6.1   # pinned
zd-tools --help
```
...
```bash
npm i -g https://github.com/Adilmunawar/ZD-claude-plugin/releases/download/v7.6.1/adilmunawar-zd-tools-7.6.1.tgz
```
